...
public class EquipmentByIpAddressDanteSqlite implements GetEquipment {
    @Override
    public Equipment getEquipment(User user, String nameCompany, String ipAddressDante) {
        ...
        try {
            ...
            while (resultSet.next()){
                if(resultSet.getString("company").equals(nameCompany)
                        && resultSet.getString("ipAddressDante").equals(ipAddressDante)){
