...
public class ListViewEquipmentPortableDatabaseMySQL implements GetListViewEquipment {
    @Override
    public ListView<Equipment> getListViewEquipment(User user, String nameCompany, String value) {
        ...
        ListView<Equipment> listView = new ListView<>(FXCollections.observableArrayList(getListEquipmentPortable.getListEquipment(user, nameCompany, "Portable")));
