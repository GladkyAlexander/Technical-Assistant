...
public class EquipmentByMac2AddressSQLite implements GetEquipment {
    @Override
    public Equipment getEquipment(User user, String nameCompany, String macAddress2) {
        ...
        try {
            ...
            while (resultSet.next()){
                if(resultSet.getString("company").equals(nameCompany)
                        && resultSet.getString("macAddress2").equals(macAddress2)){
