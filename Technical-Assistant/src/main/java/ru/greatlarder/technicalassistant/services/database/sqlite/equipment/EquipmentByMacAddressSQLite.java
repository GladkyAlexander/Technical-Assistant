...
public class EquipmentByMacAddressSQLite implements GetEquipment {
    @Override
    public Equipment getEquipment(User user, String nameCompany, String macAddress) {
        ...
        try {
            ...
            while (resultSet.next()){
                if(resultSet.getString("company").equals(nameCompany)
                        && resultSet.getString("macAddress").equals(macAddress)){
