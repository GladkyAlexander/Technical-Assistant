...
public class ListEquipmentByNameRoomSQLite implements GetListEquipment {
    @Override
    public List<Equipment> getListEquipment(User user, String companyName, String nameRoom) {
            ...
            while (resultSet.next()){
                if(resultSet.getString("company").equals(companyName)){
                        if(resultSet.getString("room") != null
                                && resultSet.getString("room").equals(nameRoom)) {
