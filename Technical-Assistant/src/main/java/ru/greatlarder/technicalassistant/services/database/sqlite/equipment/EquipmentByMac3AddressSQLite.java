...
public class EquipmentByMac3AddressSQLite implements GetEquipment {
    @Override
    public Equipment getEquipment(User user, String nameCompany, String macAddress3) {
        ...
        try {
            ...
            while (resultSet.next()){
                if(resultSet.getString("company").equals(nameCompany)
                        && resultSet.getString("macAddress3").equals(macAddress3)){
